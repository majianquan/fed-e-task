var snabbdom = require('./dist/snabbdom.js');
var patch = snabbdom.init([
  require('./dist/class').default,
  require('./dist/props').default,
  require('./dist/style').default,
  require('./dist/eventlisteners').default,
]);
var h = require('./dist/h.js').default;
