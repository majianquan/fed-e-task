module.exports = {
    ...
    rules: {
        ...
        // 禁止将 undefined 赋值给变量,警告
        'no-undef-init': 1,
        // 禁止访问未定义的变量或方法
        'no-undef': 1,
        // 禁止使用 undefined，如需判断一个变量是否为 undefined，请使用 typeof a === 'undefined'，警告
        'no-undefined': 1,
        // if 后必须包含 { ，单行 if 除外
